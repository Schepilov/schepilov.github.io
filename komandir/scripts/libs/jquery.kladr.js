    ...
    $.fn.kladr = function(param1, param2) {
        ...
        function kladr(input, param1, param2) {
            ...
            function create() {
                ...
                var inputHolder = input.closest('.typeahead-holder');
                var container   = $(document.getElementById('typeahead__' + inputName));

                if(!container.length){
                    container = $('<div id="typeahead__' + inputName +'"></div>').prependTo(inputHolder);
                }

                input.attr('autocomplete', 'off');

                ac = $('<ol class="autosuggest_'+ inputName +'" style="display: none;"></ol>');
                ac.appendTo(container); 

                spinner = $('<div class="spinner autosuggest_'+ inputName +'_spinner" class="spinner" style="display: none;"></div>');
