(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("prop-types"), require("svg-baker-runtime/browser-symbol"), require("svg-sprite-loader/runtime/browser-sprite.build"), require("react-dom"));
...
})(window, function(__WEBPACK_EXTERNAL_MODULE__0__, __WEBPACK_EXTERNAL_MODULE__1__, __WEBPACK_EXTERNAL_MODULE__6__, __WEBPACK_EXTERNAL_MODULE__7__, __WEBPACK_EXTERNAL_MODULE__31__) {
...
exports.isWebView = undefined;

var _vkuiConnect = __webpack_require__(41);

var _vkuiConnect2 = _interopRequireDefault(_vkuiConnect);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var isWebView = exports.isWebView = _vkuiConnect2.default.supports('VKWebAppInit');
...
var _CellButton = __webpack_require__(23);
...
var _AndroidSpinner = __webpack_require__(78);
...
var _removeObjectKeys = __webpack_require__(33);

var _removeObjectKeys2 = _interopRequireDefault(_removeObjectKeys);

var _PanelHeader = __webpack_require__(32);
...
var _done = __webpack_require__(21);
...
var _Slider2 = __webpack_require__(16);
...
var baseClassName = (0, _getClassName2.default)('FormStatus');
...
var FormStatus = function FormStatus(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    _extends({}, restProps, { className: (0, _classnames3.default)(baseClassName, _defineProperty({}, 'FormStatus--' + state, state), className) }),
    title && _react2.default.createElement(
      'div',
      { className: 'FormStatus__title' },
      title
    ),
    dangerouslySetInnerHTML && _react2.default.createElement('div', { className: 'FormStatus__content', dangerouslySetInnerHTML: dangerouslySetInnerHTML }),
    children && !dangerouslySetInnerHTML && _react2.default.createElement(
      'div',
...
FormStatus.propTypes = {
  state: _propTypes2.default.oneOf(['default', 'error']),
  title: _propTypes2.default.node,
  children: _propTypes2.default.node,
...
var _FixedLayout = __webpack_require__(11);
...
var _HeaderButton = __webpack_require__(29);

var _HeaderButton2 = _interopRequireDefault(_HeaderButton);

var _back = __webpack_require__(60);

var _back2 = _interopRequireDefault(_back);

var _cancel = __webpack_require__(20);
...
var _SearchIOS = __webpack_require__(63);

var _SearchIOS2 = _interopRequireDefault(_SearchIOS);

var _SearchAndroid = __webpack_require__(61);
...
var _Div = __webpack_require__(19);
...
var symbol = new _browserSymbol2.default({
  "id": "reorder_24",
  "use": "reorder_24-usage",
  "viewBox": "0 0 24 24",
  "content": "<symbol viewBox=\"0 0 24 24\" id=\"reorder_24\"><g fill=\"none\" fill-rule=\"evenodd\"><path d=\"M0 0h24v24H0z\" /><path d=\"M21 18a1 1 0 0 1-1 1H4a1 1 0 0 1 0-2h16a1 1 0 0 1 1 1zm0-4a1 1 0 0 1-1 1H4a1 1 0 0 1 0-2h16a1 1 0 0 1 1 1zm0-4a1 1 0 0 1-1 1H4a1 1 0 0 1 0-2h16a1 1 0 0 1 1 1zM3 6a1 1 0 0 1 1-1h16a1 1 0 0 1 0 2H4a1 1 0 0 1-1-1z\" fill=\"currentColor\" fill-rule=\"nonzero\" /></g></symbol>"
});
var result = _browserSprite2.default.add(symbol);
...
var _chevron = __webpack_require__(72);
...
var _reorder = __webpack_require__(71);

var _reorder2 = _interopRequireDefault(_reorder);

var _reorder_ios = __webpack_require__(70);

var _reorder_ios2 = _interopRequireDefault(_reorder_ios);
...
var Cell = function (_Component) {
  ...
  function Cell() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Cell.__proto__ || Object.getPrototypeOf(Cell)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      e.originalEvent.preventDefault();
      _this.rootEl.style.transform = 'translateY(' + e.shiftY + 'px)';
      ...
      _this.props.onDragFinish && _this.props.onDragFinish({ from: _this.dragStartIndex, to: _this.dragEndIndex });
  ...
  _createClass(Cell, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          onDragFinish = _props.onDragFinish,
          href = _props.href,
          size = _props.size,
          bottomContent = _props.bottomContent,
          restProps = _objectWithoutProperties(_props, ['before', 'indicator', 'asideContent', 'expandable', 'onClick', 'children', 'getRootRef', 'description', 'selectable', 'multiline', 'className', 'onRemove', 'removable', 'removePlaceholder', 'draggable', 'onDragFinish', 'href', 'size', 'bottomContent']);
      ...
      return _react2.default.createElement(
        ...
        _extends({}, rootProps, {
          ...
          }, _defineProperty(_classnames, 'Cell--' + size, size), _defineProperty(_classnames, 'Cell--dragging', this.state.dragging), _defineProperty(_classnames, 'Cell--draggable', draggable), _classnames), className),
          ref: this.getRootRef
        }),
        _react2.default.createElement(
          _Tappable2.default,
          ...
          _react2.default.createElement(
            ...
            osname === _platform.ANDROID && draggable && _react2.default.createElement(
              _Touch2.default,
              {
              ...
              _react2.default.createElement(_reorder2.default, null)
            ),
            before && _react2.default.createElement(
              'div',
          ...
          _react2.default.createElement(
            ...
            osname === _platform.IOS && expandable && !draggable && _react2.default.createElement(_chevron2.default, { className: 'Cell__chevron' }),
            osname === _platform.IOS && draggable && _react2.default.createElement(
              _Touch2.default,
              {
                className: 'Cell__dragger',
                onStart: this.onDragStart,
              ...
              _react2.default.createElement(_reorder_ios2.default, null)
            )
          )
        ),
...
Cell.propTypes = {
   ...
   */
  onDragFinish: _propTypes2.default.func,
  /**
...
var _keyframes = __webpack_require__(77);
...
var _ActionSheet = __webpack_require__(27);

var _ActionSheet2 = _interopRequireDefault(_ActionSheet);

var _ActionSheetItem = __webpack_require__(26);
...
var _PanelHeaderContent = __webpack_require__(88);
...
var _HeaderContext = __webpack_require__(87);
...
var _Epic = __webpack_require__(86);
...
var _TabbarItem = __webpack_require__(84);
...
var _InnerScroll = __webpack_require__(83);
...
var _HorizontalScroll = __webpack_require__(82);
...
var _NativePopouts = __webpack_require__(81);
...
var _ScreenSpinner = __webpack_require__(79);
...
var _InfoRow = __webpack_require__(68);
...
var _Entity = __webpack_require__(67);
...
var _TabsItem = __webpack_require__(58);
...
var _FixedTabs = __webpack_require__(57);
...
var _FormLayout = __webpack_require__(54);
...
var _FormLayoutGroup = __webpack_require__(53);
...
var _FormStatus = __webpack_require__(52);

Object.defineProperty(exports, 'FormStatus', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_FormStatus).default;
  }
});
...
var _RangeSlider = __webpack_require__(48);
...
var _Textarea = __webpack_require__(47);
